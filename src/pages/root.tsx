...
export default function Root() {
  ...
  return (
    <div className='bg-neutral-950 pt-4'>
      {/* back-header */}
      <header
        className={`-z-5 absolute w-full bg-neutral-950 ${!isHeaderCollapsed && 'hidden'} h-full`}
      >
            ...
            <nav className='relative flex justify-between'>
              <div className='flex items-center md:gap-x-12'>
                ...
                >
                  ...
                  <h4 className='hidden font-serif text-white sm:block md:text-lg'>
      ...
      >
        ...
        >
          <button>
            <motion.svg
              xmlns='http://www.w3.org/2000/svg'
              className='mx-auto w-16 cursor-pointer rounded-none text-black/30'
              viewBox='0 0 512 512'
              whileHover={{
                scale: 1.2,
        ...
        <header className='pb-4 pt-10'>
          <div className='mx-auto max-w-7xl rounded-t-xl bg-white px-4 sm:px-6 lg:px-8'>
            <motion.nav
              ...
              <div className='flex items-center md:gap-x-12'>
                ...
                >
                  <Link to='/'>
                    <motion.div
                      variants={itemVariants}
                      className='inline-block transform cursor-pointer rounded-lg px-2 py-1 tracking-widest text-slate-700 duration-75 hover:bg-slate-100 hover:text-slate-900 focus-visible:outline-none focus-visible:outline-1 focus-visible:outline-slate-400'
                    >
                      物种识别
                    </motion.div>
                  </Link>
              ...
              <div className='flex items-center gap-x-5 md:gap-x-8'>
                ...
                <Link to='/'>
                  <motion.div
                    ...
                    className='inline-flex transform cursor-pointer items-center justify-center rounded-full bg-purple-600 px-4 py-1.5 text-sm font-semibold text-white duration-100 hover:bg-purple-700 focus:outline-none focus-visible:outline-2 focus-visible:outline-purple-600 active:bg-purple-600 md:py-2'
                  >
                    <span>
