          ...
          <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
            ...
            <nav className='relative flex justify-between'>
              <div className='flex items-center md:gap-x-12'>
                ...
                >
                  <h2 className='font-tiny px-1 text-3xl tracking-wide text-white md:text-4xl'>
                    ECO AI
                  </h2>
                  <h4 className='font-tiny hidden text-white sm:block md:text-lg'>
          ...
          <div className='mx-auto max-w-7xl'>
            <ul className='grid grid-cols-1 sm:grid-cols-2'>
              {['My Work', 'About Me', 'My Process', 'Blog'].map((item, index) => (
                ...
                >
                  <li className='font-tiny my-auto p-5 text-3xl font-bold tracking-wide text-white sm:px-6 md:text-4xl lg:px-8'>
                    {item}
                  </li>
                </a>
              ))}
            ...
            >
              <div className='flex items-center md:gap-x-12'>
                ...
                >
                  ...
                  <h2 className='font-tiny p-1 text-2xl tracking-wide text-slate-950 md:text-3xl'>
                    ECO AI
                  </h2>
                </motion.a>
                <motion.div
